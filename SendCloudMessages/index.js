...
// This function invokes the blink command on the device. Use the Run button below to call the function.
// Provide the device id of the device you wish to call as input.
